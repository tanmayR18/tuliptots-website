  ...
  return (
    <div className="pb-12 overflow-hidden min-h-screen relative flex justify-center items-center bg-linear-to-br from-blue-300 to-blue-100  overflow-x-hidden pt-32 lg:pt-44">
      ...
      <div className=" absolute -bottom-5 right-0">
        ...
        <img src={leaves} className=" w-[100px] sm:w-[200px] lg:w-[150px] xl:w-[250px]" />
      </div>
      <img src={cloud} className=" w-[130px] hidden sm:flex absolute top-1/2 -translate-y-1/2 right-10 " />



      <div className=" absolute -top-10 -right-24 ">
        <img className=" w-[200px] sm:w-[230px] lg:w-[250px] rotate-90" src={doddle11} />
        <img src={hearts} className=" absolute bottom-12 sm:bottom-8 lg:bottom-6 left-6 sm:left-0 lg:left-0 w-[60px] sm:w-[80px] lg:w-[100px]" />
      </div>

      <div className=" absolute top-0 lg:-top-16 -left-12 lg:-left-24">
        <img className=" w-[200px] sm:w-[250px] lg:w-[350px] rotate-[120deg]" src={doddle8} />
      </div>
      <div className="w-10/12 mx-auto ">
        <div className="  flex justify-center lg:justify-end">
          <div className=" relative flex flex-col  items-center xl:-translate-x-1/4">
            ...
            <p className=" text-[#bb4207] text-center font-semibold tracking-wider text-xl mt-5">
              Preschool - Daycare - Children’s Library - Activity Centre
            </p>

            <p className="text-[#323a30] max-w-md text-center text-xl tracking-wide leading-6 font-semibold mt-5">
        ...
        <img
          className=" hidden lg:flex h-[calc(100vh-140px)]  absolute bottom-0 -translate-x-5 xl:translate-x-0"
