...
const Vision = () => {
  return (
    <div className=" bg-amber-200 p-5 sm:p-8 md:p-12 flex flex-col  items-center md:gap-8 rounded-4xl">
      <p className=" text-2xl sm:text-3xl md:text-4xl font-bold text-black text-center">OUR VISION</p>
      <p className=" mt-5 md:mt-10 text-lg md:text-xl font-semibold text-center">
