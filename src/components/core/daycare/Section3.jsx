    ...
    <div className=" min-h-screen relative overflow-hidden bg-[#afe9e4] z-20 py-20 font-kgPrimaryPenmanship">
      <div className=" relative z-40 pt-16">
        <div className=" flex flex-row gap-2 justify-center items-center">
          <img className=" w-[40px] h-[30px] sm:w-[60px] sm:h-[40px] xl:h-auto xl:w-[90px]" src={doddle13} />
        ...
        <div className=" flex flex-col md:flex-row items-center mx-auto gap-6 px-4 lg::w-10/12 ">
          <img src={image1} className=" w-10/12 md:w-1/2" />
      ...
      <div className=" absolute top-0 -right-[100px]  ">
        ...
        <img className=" hidden md:flex w-[250px] absolute top-4 -left-[120px]" src={doddle5} />
      </div>
